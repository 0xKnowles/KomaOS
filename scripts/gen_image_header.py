...
# Keeps generated comments inside .clang-format's 120-column limit.
COMMENT_WIDTH = 114
...
def emit(name, width, height, data, per_line=19, provenance=None):
    ...
    if provenance:
        ...
        #
        # Wrapped, because src/images is not excluded from the repo's format
        # check and .clang-format has a 120-column limit. A single over-long
        # line does not just get split -- clang-format re-flows the whole
        # comment paragraph and folds the following lines into it, turning
        # "Do not edit by hand." into part of the command. Keeping every line
        # inside the limit leaves the block alone.
        lines += textwrap.wrap(
            f"Generated by {provenance}",
            width=COMMENT_WIDTH,
            initial_indent="// ",
            subsequent_indent="//   ",
