...
KomaOS supports loading additional fonts from the SD card, including fonts
...
1. Connect your KomaOS reader to Wi-Fi
...
3. Insert the SD card and power on your KomaOS reader
...
To avoid shipping a large CJK glyph set in flash, KomaOS instead reuses the
...
so KomaOS loads your SD family at those sizes too and maps each UI font to
