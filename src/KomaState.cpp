...
bool KomaState::isRecentSleep(uint16_t idx, uint8_t checkCount) const {
...
void KomaState::pushRecentSleep(uint16_t idx) {
...
void KomaState::toJson(JsonDocument& doc) const {
...
bool KomaState::fromJson(JsonVariantConst doc) {
