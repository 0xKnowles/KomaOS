#include "KomaWebServerActivity.h"
...
constexpr const char* AP_SSID = "KomaOS-Reader";
constexpr const char* AP_PASSWORD = nullptr;  // Open network for ease of use
constexpr const char* AP_HOSTNAME = "komaos";
...
void KomaWebServerActivity::onEnter() {
  Activity::onEnter();
...
void KomaWebServerActivity::onExit() {
  Activity::onExit();
...
void KomaWebServerActivity::onNetworkModeSelected(const NetworkMode mode) {
...
void KomaWebServerActivity::onWifiSelectionComplete(const bool connected) {
...
void KomaWebServerActivity::startAccessPoint() {
...
void KomaWebServerActivity::startWebServer() {
  LOG_DBG("WEBACT", "Starting web server...");

  // Create the web server instance
  webServer.reset(new KomaWebServer());
  webServer->begin();
...
void KomaWebServerActivity::loop() {
...
void KomaWebServerActivity::render(RenderLock&&) {
...
void KomaWebServerActivity::renderServerRunning() const {
  const auto& metrics = UITheme::getInstance().getMetrics();
  const auto pageWidth = renderer.getScreenWidth();
...
void KomaWebServerActivity::renderWifiIndicator(int subHeaderTop) const {
