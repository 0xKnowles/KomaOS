...
#include "network/KomaWebServer.h"
...
/**
 * KomaWebServerActivity is the entry point for file transfer functionality.
 * It:
 ...
 * - Starts the KomaWebServer when connected
 * - Handles client requests in its loop() function
 * - Cleans up the server and shuts down WiFi on exit
 */
class KomaWebServerActivity final : public Activity {
  ...
  std::unique_ptr<KomaWebServer> webServer;
 ...
 public:
  explicit KomaWebServerActivity(GfxRenderer& renderer, MappedInputManager& mappedInput)
      : Activity("KomaWebServer", renderer, mappedInput) {}
