...
void ButtonRemapActivity::loop() {
  ...
  if (mappedInput.wasPressed(MappedInputManager::Button::Up)) {
    ...
    SETTINGS.frontButtonBack = KomaSettings::FRONT_HW_BACK;
    SETTINGS.frontButtonConfirm = KomaSettings::FRONT_HW_CONFIRM;
    SETTINGS.frontButtonLeft = KomaSettings::FRONT_HW_LEFT;
    SETTINGS.frontButtonRight = KomaSettings::FRONT_HW_RIGHT;
    SETTINGS.saveToFile();
    finish();
    return;
  }
...
const char* ButtonRemapActivity::getHardwareName(const uint8_t buttonIndex) const {
  switch (buttonIndex) {
    case KomaSettings::FRONT_HW_BACK:
      return tr(STR_HW_BACK_LABEL);
    case KomaSettings::FRONT_HW_CONFIRM:
      return tr(STR_HW_CONFIRM_LABEL);
    case KomaSettings::FRONT_HW_LEFT:
      return tr(STR_HW_LEFT_LABEL);
    case KomaSettings::FRONT_HW_RIGHT:
