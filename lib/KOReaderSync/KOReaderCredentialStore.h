...
class KOReaderCredentialStore : public PersistableStore<KOReaderCredentialStore> {
 ...
 public:
  static const char* getFilePath() { return "/.komaos/koreader.json"; }
  ...
  // Whether API calls target the KomaOS sync server that supports protocol extensions.
  bool usesKomaSyncServer() const;
