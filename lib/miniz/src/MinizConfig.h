/* KomaOS only needs miniz's low-level streaming inflate (tinfl). The
...
// komaos_ (NOT freeink_) so a future branch that links FreeInkBook's
// identically-renamed copy does not collide.
#define tinfl_decompress komaos_tinfl_decompress
#define tinfl_decompress_mem_to_heap komaos_tinfl_decompress_mem_to_heap
#define tinfl_decompress_mem_to_mem komaos_tinfl_decompress_mem_to_mem
#define tinfl_decompress_mem_to_callback komaos_tinfl_decompress_mem_to_callback
#define mz_crc32 komaos_mz_crc32
#define mz_adler32 komaos_mz_adler32
#define mz_free komaos_mz_free
