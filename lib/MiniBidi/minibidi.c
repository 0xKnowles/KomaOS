/*
 * minibidi.c — Unicode Bidirectional Algorithm (UAX #9) for KomaOS/ESP32C3
 *
 ...
 *
 * KomaOS deviations from the upstream code, each marked inline:
 ...
 *      in its bidi_char array; in KomaOS they are real array entries
...
/* ── KomaOS extension: joining types outside U+0621–U+064A ──────────
...
/* ── KomaOS extension: presentation forms outside U+0621–U+064A ─────
...
/* KomaOS deviation 1: NSM marks (harakat) sit between letters in our
