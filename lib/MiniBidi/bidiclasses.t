/* bidiclasses.t — bidi class table for KomaOS RTL (Hebrew/Arabic) epub.
 *
 * Coverage rationale:
 *   Hebrew and Arabic-script languages (Arabic, Farsi, Urdu, Sindhi, Pashto,
 *   Kurdish) are the RTL targets. KomaOS also renders Latin and Cyrillic
 ...
 *   scripts KomaOS's fonts don't support (CJK, Devanagari, etc.)
...
/* ── Cyrillic (L) ────────────────────────────────────────────────────── */
/* Required: KomaOS supports Russian, Ukrainian, Bulgarian, etc.
...
/* Covers accented chars for Vietnamese, Welsh, Romanian, etc.
   Not currently rendered by KomaOS fonts, but costs only 2 table rows. */
{0x1E00, 0x1EFF, L},
