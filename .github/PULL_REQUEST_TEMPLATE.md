...
KomaOS is intentionally narrow. See [SCOPE.md](../blob/master/SCOPE.md) and [ROADMAP.md](../blob/master/ROADMAP.md).
Please confirm:
...
- [ ] The stock firmware does not already handle this well, **and** no other popular KomaOS fork already does
      (or, if one does, I explain why KomaOS still needs it below).
...
While KomaOS doesn't have restrictions on AI tools in contributing, please be transparent about their usage as it
